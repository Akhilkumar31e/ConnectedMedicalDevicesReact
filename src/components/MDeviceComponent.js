...
class MDevice extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        ...
        return(
            <React.Fragment>
                {!this.state.deviceFound && <Redirect to="/manager" />}
                <HomeHeader />
                <div className="container">
                    <div className="row pad-row">
                        <div className="col-12">
                    <Breadcrumb>
                        <BreadcrumbItem><span className="fa fa-arrow-left">    .</span><Link to="/manager">Manager</Link></BreadcrumbItem>
                ...
                {this.state.isLoading ? <Loading /> : <div className="main">
                    ...
                    <div className="row row-display row-edu">
                        ...
                        <div className="col-12 col-sm-6">
                            <h4> {this.state.deviceInfo.operatingTime} </h4>
                        </div>
                    </div>
                    <div className="row row-display row-edu">
                        <div className="col-12 col-sm-4">
